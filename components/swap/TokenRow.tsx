  ...
  return (
    <div className="rounded-2xl p-4 bg-black/20 border border-white/10 shadow-sm">
      ...
      <div className="mt-3 flex items-center gap-3">
        ...
        {showMax && (
  <button onClick={onMaxClick} disabled={!!readOnlyAmount} className="ml-2 text-xs px-2 py-1 rounded bg-white/10 hover:bg-white/20 disabled:opacity-50 disabled:hover:bg-white/10 disabled:cursor-not-allowed">MAX</button>
)}
      </div>
